              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={formData.name}
                    onChange={handleInputChange}
                    placeholder="e.g. Tesla Model 3, Ola S1 Pro"
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. 350km"
                    className={errors.batteryRange ? 'error' : ''}
                  />
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={errors.acceleration ? 'error' : ''}
                  />
